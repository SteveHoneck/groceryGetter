...
const ListItem = (props) => { //props will be "checkBoxToggle" function and one object from the map function in the "ListComponent" which has been renamed "item". DESTRUCTURE PROPS AND REFACTOR CODE BELOW????
